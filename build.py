...
def get_cli_arguments():
    ...
    parser = builder.get_arg_parser("sodium", "1.0.18", 1, __file__, [builder.TARGET_ANDROID_x86_64, builder.TARGET_ANDROID_arm64_v8a])
...
if __name__ == "__main__":
    ...
    builder.fetch_source(
        args=args,
        source=f"https://github.com/jedisct1/libsodium/archive/refs/tags/{args.version}.tar.gz",
        extract="tar.gz",
    )
